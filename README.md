# holiday_spending
NRF/BIG research provided results of a consumer holiday spending survey (USAToday,)


## Holiday Spending Data Analysis (Sample of 25 Customers)
🔹 Step 1: Understanding the Raw Data

📝 Holiday Spending Data (Sample of 25 Customers)
...
| Spending Range | Frequency | Percent |
| -------------- | --------- | ------- |
| 0 – 249        | 3         | 12%     |
| 250 – 499      | 6         | 24%     |
| 500 – 749      | 5         | 20%     |
...
* 44% of customers (250–749 range) are moderate spenders.
...
Although high spenders are fewer:
